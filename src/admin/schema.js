...

  {
    ...
    fields: [
      ...
      { type: 'text', key: 'instagramUrl', label: 'Instagram profile URL' },
      {
        ...
        fields: [
          { type: 'image', key: 'src', label: 'Photo', variant: 'photo', help: 'Shown in the grid, and as the poster frame if a video is added below.' },
          { type: 'text', key: 'alt', label: 'Description', help: 'Describe the photo for visitors using screen readers.' },
          { type: 'video', key: 'video', label: 'Video (optional)', help: 'Leave empty for a plain photo. If set, the photo above is shown until someone opens it, then this plays.' },
        ],
      },
    ],
  },
